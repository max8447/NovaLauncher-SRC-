...
namespace NovaLauncher.Views.Controls.Settings
{
    ...
    /// </summary>
    public partial class InstantResetOption : UserControl
    {
        public InstantResetOption()
        {
            InitializeComponent();
            ...
            bool? bEnableEOR = (bool?)settings.bInstantReset;
